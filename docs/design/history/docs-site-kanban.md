...
- `docs/design/*.md` + `spec/index.html` + `spec.js`
...
- [x] `docs/design/`에서 카테고리별 MD를 브라우저로 열 수 있다
...
- `docs/design/`은 현황 정본(동작 변경 시 **같은 feature에서 필수 갱신**), `docs/design/history/`는 feature 정본
