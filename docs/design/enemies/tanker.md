...
- 실드 피격은 본체 HP를 깎지 않고, 실드 파괴 후에만 본체가 드러난다.
- Tanker는 투사체를 발사하지 않는다.
- 검증: `tests/tanker_enemy_smoke_test.gd`

## 변경 이력

- 2026-09-15: 적 목록에서 누락됐던 Tanker 상세 문서를 복구·등록.
- 2026-08-09: 실드 피격 피드백·사격 제거 (이력: [tanker-hit-feedback](../history/tanker-hit-feedback.md)).
