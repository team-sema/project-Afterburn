...
| | `laser_refract` | 굴절 중계 — 보조 빔 피해 55% |
| | `laser_pulse` | 펄스 발진 — 0.7초 온/0.35초 오프 · 온 시 피해 ×2 |
...
| 보조 캐넌 | `aux_heavy_barrel` | 대구경 포신 — 피해 ×1.8 · 크기 ×1.3 · 간격 ×1.2 |
...
| | `plasma_cluster` | 집속 폭발 — 피해 ×0.9 + 소형 3발(각 40%) |
| | `plasma_field` | 잔류 플라즈마장 — 피해 ×0.95 + 3초 지대 |
