...
코드 확인: 2026-09-17. 현재 구현된 API의 사용 설명이다. 게임 규칙의 정본은 [전투 기획서](design/combat.md), 작업·검증 기록은 [탄막 API 작업 기록](design/tasks/barrage-api-tasks.md)이다. 별도 API 문서를 요청한 데 따라 사용 계약을 모아 두었다. API 변경 시 이 문서도 함께 갱신한다.
